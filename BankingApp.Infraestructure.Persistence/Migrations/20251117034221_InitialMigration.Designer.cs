...
namespace BankingApp.Infraestructure.Persistence.Migrations
{
    ...
    [Migration("20251117044442_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankingApp.Core.Domain.Entities.Installment", b =>
            {
                ...
                // DateOnly supported in .NET 6+; column type date
            ...
            modelBuilder.Entity("BankingApp.Core.Domain.Entities.Transaction", b =>
            {
                ...
                // CORREGIDO: Description como string con MaxLength 100
                b.Property<string>("Description")
                    .HasMaxLength(100)
                ...
                // CORREGIDO: TellerId con nvarchar(450) coherente con HasMaxLength(450)
